...
class PestPredictor:
    def __init__(self, model_path, pest_info_path):
        ...
        # Initialize model
        self.model = resnet18(pretrained=True)  # Load with pretrained weights first
...
def main():
    try:
        ...
        print("3. Make sure the model file was saved with both state_dict and class_to_idx")
